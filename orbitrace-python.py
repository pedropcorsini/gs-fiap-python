# ============================================================
# Projeto : Orbitrace - Monitor de Conjuncoes Orbitais
...
def sobre_projeto():
    """Exibe informações gerais sobre o Orbitrace."""
    limpar_tela()
    print('=' * 48)
    exibir_nome_programa()
    print('=' * 48)
    print('SOBRE O ORBITRACE')
    print()
    print('Orbitrace monitora detritos espaciais e calcula riscos de conjunção')
